...
export const  ContainerImages = styled.div<{press:boolean}>`
    ...
    props.press
      ? css`
        ...
        .duas {
            z-index: 3;
            transform: perspective(50rem) rotateY(40deg) rotateX(40deg) translateY(1rem) translateX(1rem);
            transition-duration: 1.2s;
        }
        .tres {
            z-index: 2;
            transform: perspective(50rem) rotateY(40deg) rotateX(40deg) translateY(3.8rem) translateX(-1.5rem);
            transition-duration: 1s;
        }
        .quatro {
            z-index: 1;
            transform: perspective(50rem) rotateY(40deg) rotateX(40deg) translateY(6.5rem) translateX(-1.5rem);
        ...
        :hover   .duas {
                z-index: 3;
                transform: perspective(50rem) rotateY(35deg) rotateX(45deg) translateY(2.6rem) translateX(-0.9rem) scale(0.9);
                transition-duration: 0.4s;
            }
        :hover   .tres {
                z-index: 2;
                transform: perspective(50rem) rotateY(35deg) rotateX(35deg) translateY(4.5rem) translateX(-1.5rem) scale(0.9);
                transition-duration: 1s;
            }
        :hover   .quatro {
                z-index: 1;
                transform: perspective(50rem) rotateY(35deg) rotateX(35deg) translateY(6.5rem) translateX(-2.5rem) scale(0.9);
